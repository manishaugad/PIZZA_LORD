...
function DashboardTab() {
  ...
  const { mode, getproduct, edithandle, deleteProduct, order, user } = context;
      ...
      <div className="container mx-auto">
        <div className="tab container mx-auto ">
          <Tabs defaultIndex={0} className=" ">
            <TabList className="flex flex-col md:flex-row md:justify-center space-y-4 md:space-y-0 md:space-x-8 bg-grid grid-cols-2 text-center gap-4 md:justify-center mb-10">
              <Tab>
                <button
                  type="button"
              ...
              <div className="  px-4 md:px-0 mb-16">
                ...
                <div className=" flex justify-end">
                  <button
                    onClick={add}
                    type="button"
                    className="focus:outline-none text-white bg-red-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-green-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2"
                    style={{
